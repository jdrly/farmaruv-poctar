        ...
        <div className="space-y-8 p-6">
            ...
            {(error || errorMessage) && (
                <Alert variant="destructive">
                    ...
                    <AlertDescription>{errorMessage ?? error?.message ?? t.calculator.errorInitializing}</AlertDescription>
                </Alert>
            )}
            ...
            <Card>
                <CardContent className="pt-6">
                    <AnimalCountInput value={animalCount} onChange={saveAnimalCount} isLoading={isPending} />
                </CardContent>
            </Card>
