        ...
        <Card className="max-w-md text-center">
          <CardContent className="pt-6">
            ...
            <h2 className="mb-2 text-xl font-semibold">
              {language === 'cs' ? 'Děkujeme!' : 'Thank you!'}
            </h2>
      ...
      <div className="mb-8">
        ...
        <p className="mt-2 text-muted-foreground">
          {language === 'cs'
            ...
            : 'Help us improve the Farmer\'s Calculator.'}
        </p>
      </div>
        ...
        <Card>
          <CardHeader className="pb-4">
            <CardTitle className="flex items-center gap-3">
              ...
              <span>
                {language === 'cs' ? 'Vaše zpětná vazba' : 'Your Feedback'}
              </span>
            </CardTitle>
            <CardDescription>
              {language === 'cs'
                  ...
                  {(field) => (
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        placeholder={
                          language === 'cs' ? 'Vaše jméno' : 'Your first name'
                        }
                      />
                  ...
                  {(field) => (
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onBlur={field.handleBlur}
                        placeholder={
                          language === 'cs' ? 'Vaše příjmení' : 'Your last name'
                        }
                      />
                      {field.state.meta.isTouched &&
                        field.state.meta.errors[0] && (
                ...
                {(field) => (
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onBlur={field.handleBlur}
                      placeholder={
                        language === 'cs' ? 'vas@email.cz' : 'your@email.com'
                      }
                    />
                    {field.state.meta.isTouched &&
                      field.state.meta.errors[0] && (
                ...
                {(field) => (
                  <div className="space-y-2">
                    ...
                    <Textarea
                      ...
                      placeholder={
                        language === 'cs'
                          ? 'Popište svůj nápad nebo problém...'
