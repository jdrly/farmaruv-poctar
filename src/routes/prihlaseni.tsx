            ...
            <Card className="relative z-10 w-full max-w-4xl overflow-hidden border-0 bg-white/5 p-0 shadow-2xl shadow-emerald-950/50 backdrop-blur-xl">
                <CardContent className="grid p-0 md:grid-cols-2">
                        ...
                        <div className="flex flex-col gap-6">
                            ...
                            <div className="flex flex-col items-center text-center">
                                ...
                                <p className="mt-2 text-white/60">
                                    {flow === 'signIn' ? t.auth.signInDescription : t.auth.signUpDescription}
                                </p>
                            </div>
                    ...
                    <div className="relative hidden overflow-hidden md:block">
                        <img src="/login_bg_fp.webp" alt={t.auth.title} className="absolute inset-0 h-full w-full object-cover" />
                        ...
                        <div className="absolute bottom-0 left-0 right-0 bg-linear-to-t from-slate-900/90 to-transparent p-8">
                            <p className="text-sm text-white/70">
                                ...
                                <a href="/gdpr" className="text-emerald-400 underline-offset-2 hover:underline">
