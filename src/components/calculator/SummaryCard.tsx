        ...
        <Card className="border-0 bg-muted/30">
            ...
            <CardContent className="space-y-6">
                ...
                <div className="rounded-lg bg-slate-100 p-4 dark:bg-slate-800">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <BalanceItem title={t.calculator.monthlyBalance} value={monthlyProfit} formatCurrency={formatCurrency} />
                        <BalanceItem title={t.calculator.yearlyBalance} value={yearlyProfit} formatCurrency={formatCurrency} />
                    </div>
                </div>
            </CardContent>
        </Card>
