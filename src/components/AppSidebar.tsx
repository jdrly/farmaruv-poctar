                ...
                <SidebarGroup>
                    <SidebarGroupContent>
                        <SidebarMenu>
                            ...
                            <Collapsible open={infoOpen} onOpenChange={setInfoOpen} className="group/collapsible">
                                <SidebarMenuItem>
                            ...
                            {/* Feedback */}
                            <SidebarMenuItem>
                                <SidebarMenuButton asChild isActive={isActive('/app/zpetna-vazba')} tooltip={t.nav.feedback}>
                ...
                <SidebarMenu>
                    <SidebarMenuItem>
                        <DropdownMenu>
                            ...
                            <DropdownMenuContent side="top" align="start" className="w-[--radix-dropdown-menu-trigger-width] min-w-40">
                                <DropdownMenuItem onClick={() => setLanguage('cs')} className="flex items-center justify-between">
                                    <span>🇨🇿 Čeština</span>
